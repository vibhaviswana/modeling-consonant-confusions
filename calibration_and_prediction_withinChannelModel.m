% Calibrates the within-channel model with SiSSN data, 
...
temp = load(fullfile(ANsimResultPath,'withinChannelModelOutput'));
...
xlabel('Neural confusion matrix entry for within-channel model','fontsize',22);
...
save predictions_SiB_withinChannel A B; % Change filename to match predConds
